...
const Carousels = {
  projectsData: [
    ...
    },
    {
      ...
      tags: ['Python', 'LangChain', 'Claude API', 'WebSocket', 'Docker'],
      github: 'https://github.com/JorgeMoralesNova'
    },
    {
      id: 7,
      ...
      tags: ['Python', 'LangChain', 'Claude API', 'MongoDB', 'Docker'],
      github: 'https://github.com/JorgeMoralesNova'
    },
    {
      id: 8,
  ...
  initTechMarquee() {
    ...
    const techs = [
      ...
      { name: 'Claude / OpenAI / LangChain', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>' },
